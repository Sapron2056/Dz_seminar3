...
Для того чтобы озменения локального репозитория были отправлены на интернет ресурс GitHub, необходимо в терминале прописать команду **Git push**. Предварительно все необходимо закомитить.
